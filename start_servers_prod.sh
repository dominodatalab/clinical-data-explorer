...
MCP_APP_KEEPALIVE_TIMEOUT="${MCP_APP_KEEPALIVE_TIMEOUT:-10}"
...
FLASK_APP_KEEPALIVE_TIMEOUT="${FLASK_APP_KEEPALIVE_TIMEOUT:-10}"

UVICORN_LOG_LEVEL="${UVICORN_LOG_LEVEL:-info}"
GUNICORN_LOG_LEVEL="${GUNICORN_LOG_LEVEL:-info}"
FORWARDED_ALLOW_IPS="${FORWARDED_ALLOW_IPS:-*}"

echo "KEPPALIVE $MCP_APP_KEEPALIVE_TIMEOUT"
echo "KEPPALIVE $FLASK_APP_KEEPALIVE_TIMEOUT"
