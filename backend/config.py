...
CURRENT_DATASET_CONTEXT_CACHE_TTL_SECONDS = int(os.environ.get("CURRENT_DATASET_CONTEXT_CACHE_TTL_SECONDS", 24 * 60 * 60))
CURRENT_DATASET_CONTEXT_CACHE_MAX_ITEM_COUNT = int(os.environ.get("CURRENT_DATASET_CONTEXT_CACHE_MAX_ITEM_COUNT", 1000))
